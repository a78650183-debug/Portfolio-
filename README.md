...
<html lang="en">
 <head>
  ...
  <title>Anilkumar - Cyber Athlete Portfolio</title>
 ...
 <body>
  ...
  <main><!-- Hero Section -->
   <section class="hero-section">
    <div class="athlete-card neon-glow">
     ...
     <h1 class="athlete-name" id="athlete-name">Anilkumar</h1>
   ...
   <section class="achievements-section">
    ...
    <div style="max-width: 800px; margin: 0 auto 4rem auto;">
     ...
     <div style="display: grid; grid-template-columns: repeat(auto-fit, minmax(250px, 1fr)); gap: 1.5rem;">
      <div class="stat-item" style="cursor: pointer;" onclick="window.open('mailto: Anilkumar@email.com', '_blank')">
    ...
    <div style="max-width: 1000px; margin: 0 auto;">
     ...
     <div style="display: grid; grid-template-columns: repeat(auto-fit, minmax(200px, 1fr)); gap: 1.5rem;">
      <div class="achievement-badge" style="cursor: pointer; position: relative;" onclick="window.open('https://linkedin.com/in/Anilkumar', '_blank', 'noopener,noreferrer')">
       <div class="energy-trail"></div>
      ...
      <div class="achievement-badge" style="cursor: pointer; position: relative;" onclick="window.open('https://github.com/Anilkumar', '_blank', 'noopener,noreferrer')">
       <div class="energy-trail"></div>
       <div style="font-size: 2.5rem; margin-bottom: 1rem;">
        💻
       </div>
      ...
      <div class="achievement-badge" style="cursor: pointer; position: relative;" onclick="window.open('https://twitter.com/Anilkumar_sec', '_blank', 'noopener,noreferrer')">
       <div class="energy-trail"></div>
       <div style="font-size: 2.5rem; margin-bottom: 1rem;">
        🐦
       </div>
      ...
      <div class="achievement-badge" style="cursor: pointer; position: relative;" onclick="window.open('https://medium.com/@Anilkumar', '_blank', 'noopener,noreferrer')">
       <div class="energy-trail"></div>
       <div style="font-size: 2.5rem; margin-bottom: 1rem;">
        📝
       </div>
      ...
      <div class="achievement-badge" style="cursor: pointer; position: relative;" onclick="window.open('https://youtube.com/@AnilkumarCyber', '_blank', 'noopener,noreferrer')">
       <div class="energy-trail"></div>
       <div style="font-size: 2.5rem; margin-bottom: 1rem;">
        📺
       </div>
  ...
  <script>
        ...
        const defaultConfig = {
            ...
            cert4_issuer: "Udemy",
            cert4_date: "2023",
            email: "Anilkumar@email.com",
            phone: "+91 98765 43210",
            location: "Hyderabad, India",
            linkedin_handle: "@Anilkumar",
            github_handle: "@Anilkumar",
            twitter_handle: "@Anilkumar_sec",
            discord_handle: "Anilkumar#2024",
            medium_handle: "@Anilkumar",
            youtube_handle: "AnilkumarCyber"
        };
